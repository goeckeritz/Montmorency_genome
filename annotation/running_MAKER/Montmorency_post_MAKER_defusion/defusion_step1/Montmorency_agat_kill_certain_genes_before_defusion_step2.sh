...
agat_sp_filter_feature_from_kill_list.pl --gff Pcerasus_montAv5_p99_400k_STANDARD.all.sorted.clean.gff --type gene,mRNA,exon,five_prime_UTR,CDS,three_prime_UTR --kill_list genes_to_remove.txt --output Pcerasus_montAv5_p99_400k_STANDARD.all.sorted.clean.post_agat.gff 
