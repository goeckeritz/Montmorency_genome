...
#SBATCH -o /mnt/gs21/scratch/goeckeri/orthofinder_montAv5_scaffolded/Genomes/RAxML/polyploidy_event_est/RAxML_top7_%j
...
raxml-ng --all --threads 12 --msa combined_topology7_species_MSAs.fa --model GTR+G --tree pars{10} --bs-trees 500 --outgroup M_x_domestica
